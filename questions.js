...
const QUESTIONS_CATALOG = {
    ...
    questions: [
        ...
        },
        {
            id: "DT-12",
            theme: "Données de Test & Conformité",
            profiles: ["managers", "dev", "qa", "env", "all"],
