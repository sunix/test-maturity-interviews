...
const QUESTIONS_CATALOG = {
    ...
    questions: [
      ...
      },
      {
        ...
        "question": "Un plan de transition vers des applications conteneurisées est-il défini et suivi ?",
        "category": "Move to Cloud",
        "weight": 2
      },
      {
        "id": "GO-25",
        ...
        "question": "Une trajectoire stratégique (objectifs, cas d'usage ciblés, horizon) est-elle définie pour l'intégration de l'IA dans les pratiques de testing ?",
        "category": "IA",
        "weight": 2
      },
      {
      ...
      },
      {
        ...
        "question": "Un cadre existe-t-il et est-il déjà mis en œuvre concernant l'utilisation de l'IA pour les activités de testing ?",
        "category": "IA",
        "weight": 1
      },
      {
        ...
        "question": "Les développeurs utilisent-ils des outils d'IA pour assister les activités de testing (tests unitaires, tests d'intégration, refactoring de tests, automatisation) ?",
        "category": "IA",
        "weight": 1
      },
      {
        ...
        "question": "L'équipe QA / Métier / BA utilise-t-elle des outils d'IA pour assister les activités de testing (définition des critères d'acceptation, rédaction des scénarios ou cahiers de recette, préparation des campagnes de tests) ?",
        "category": "IA",
        "weight": 1
      },
      {
      ...
      },
      {
        ...
        "question": "Les applications sont-elles déployées en production sous forme de conteneurs (Docker, Kubernetes, OpenShift ou équivalent) ?",
        "category": "Move to Cloud",
        "weight": 2
      },
      {
        ...
        "question": "Les environnements hors production (DEV, SIT, UAT) sont-ils hébergés et testés dans des environnements cloud ?",
        "category": "Move to Cloud",
        "weight": 2
      },
      {
        ...
        "question": "Les équipes de développement utilisent-elles des conteneurs pour tester leurs développements ?",
        "category": "Move to Cloud",
        "weight": 2
      },
      {
        ...
        "question": "Les équipes DevOps/ProdApp/Env supportent-elles l'utilisation de conteneurs dans les environnements de dev, test ou de production ?",
        "category": "Move to Cloud",
        "weight": 2
      },
      {
